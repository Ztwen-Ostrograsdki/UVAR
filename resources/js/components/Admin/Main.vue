	...
	<div class="w-100 p-0 m-0">
        ...
        <div class="w-90 mx-auto p-0 m-0 my-2 mt-lg-5">
            <div class="mx-auto w-100" v-if="connected && active_member && active_member.id && user && user.role == 'admin' && $route.name !== 'membersProfil'">
               <div class="px-3 d-none d-sm-flex justify-content-start">
               ...
               <div class="px-3 d-flex d-sm-none flex-column justify-content-center">
                   <router-link class="btn-official my-1" :to="{name: 'usersListing'}">Les utilisateurs</router-link>
                   <router-link class="btn-official" :to="{name: 'membersListing'}">Les membres</router-link>
                   <router-link class="btn-official my-1" :to="{name: 'actionsListing'}">Les actions</router-link>
                   <router-link class="btn-official" :to="{name: 'productsListing'}">Les produits</router-link>
                   <router-link class="btn-official my-1" :to="{name: 'categoriesListing'}">Les Catégories</router-link>
                   <router-link class="btn-official" :to="{name: 'notifications'}">Les demandes d'affiliations</router-link>
                   <router-link class="btn-official my-1" :to="{name: 'requests'}">Les demandes d'achat</router-link>
               </div> 
            </div>
