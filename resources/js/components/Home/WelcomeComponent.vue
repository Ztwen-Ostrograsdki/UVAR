    ...
    <div class="w-100 mx-auto d-flex justify-content-center flex-column">
        <transition name="scalefade" appear>
            <div class="w-75 mx-auto my-2 py-2 d-flex justify-content-center">
                <span class="btn btn-primary border-white px-3 px-lg-5 mr-1" @click="toggleDisplay('actions')">Les Actions <span class="d-none d-sm-inline">disponibles</span> </span>
                <span class="fa cursor fa-refresh text-warning fa-2x mx-2 mt-1" title="Afficher d'autres" @click="getOthers"></span>
                <span class="btn btn-primary border-white px-3 px-lg-5 ml-1" @click="toggleDisplay('products')">Les Articles <span class="d-none d-sm-inline">disponibles</span> </span>
            </div>
        </transition>
        <div class="w-95 mx-auto oneProperty mt-2" v-if="onActions">
            <div class="w-100 d-flex justify-content-start mb-0 mt-2">
                <h5 class="text-official d-none d-sm-block p-0 m-0 mb-1"><span class="fa-2x">Les Actions UVAR à la une</span>
                    <span v-if="isLoadedSelectedActions && selectedActions.length > 0" class="text-white-50 ml-2" >
                        (Plus de centaines d'actions vendues chaque semaine sur UVAR)
                    </span>
                </h5>
                <h5 class="text-official d-block d-sm-none p-0 m-0 mb-1"><span class="d-block">Les Actions UVAR</span>
                    <span style="font-size: 12px;" v-if="isLoadedSelectedActions && selectedActions.length > 0" class="text-white-50 ml-2">
                        (Plus de centaines d'actions vendues chaque semaine sur UVAR)
                    </span>
                </h5>
        ...
        <div class="w-95 mx-auto oneProperty mt-2" v-if="onProducts">
            <div class="w-100 d-flex justify-content-start mb-0 mt-2">
                <h5 class="text-official d-none d-sm-block p-0 m-0 mb-1"><span class="fa-2x">Bienvenue à la boutique UVAR</span>
                    <span v-if="isLoadedSelectedProducts && selectedProducts.length > 0" class="text-white-50 ml-2">
                        (Plus de centaines d'articles vendus chaque semaine sur UVAR)
                    </span>
                </h5>
                <h5 class="text-official d-block d-sm-none p-0 m-0 mb-1"><span class="d-block">Bienvenue à la boutique UVAR</span>
                    <span  style="font-size: 12px;" v-if="isLoadedSelectedProducts && selectedProducts.length > 0" class="text-white-50 ml-2">
                        (Plus de centaines d'articles vendus chaque semaine sur UVAR)
                    </span>
                </h5>
            </div>
                                    ...
                                    <div class="w-100">
                                        <transition name="scalefade" appear>
                                            <div title="Double cliquer pour masquer l'image" @dblclick="hideProductImage()" v-if="showProductImage && profilProductID  && profilProductID == product.product.id" class="w-100 p-0 m-0 float-left h-100">
                                                <img v-if="product.images.length < 1" class="p-0 m-0 w-100 h-100" src="/photo/ph2.jpg">
                                                 <img v-if="product.images.length > 0" class="p-0 m-0 w-100 h-100" :src="'/images/'+ getProfilPath(product.images)">
                                            </div>
                                        </transition>
