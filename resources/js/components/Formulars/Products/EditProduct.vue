        ...
        <div class="modal-content bg-linear-official-50 border border-white">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal">
                    ...
                    <div class="row px-3">                           
                        <div class="col-9">
                            <button type="button"class="btn btn-primary border border-white py-2 px-3 btn-radius" @click="updateProduct()">
                                Mettre à jour
                            </button>
                            <button @click="cancelImage()" type="button" data-dismiss="modal" aria-hidden="true" class="btn btn-secondary btn-radius py-2 px-3 border border-dark">
                                Avorter</button>
                        </div>
                    </div>
                </form>
